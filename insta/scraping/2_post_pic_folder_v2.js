...
const jsonData = require('./Okti.json');

const hashtag = '\n#42Network #Campus #born2code #Programación #Tecnología #Coding #Code #Hacker #Hacking #Learning #Barcelona #Technology #WebDevelopment #Barcelona #programacion '
...
(async () => {
	...
	// Autenticación de usuario y contraseña
		ig.state.generateDevice('okt.oro');
		await ig.account.login('okt.oro', 'Armadura@114');
