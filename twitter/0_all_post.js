...
const getPosts = async () => {
	...
	return (res.data);
	// return (res.data.data.user.result.timeline_v2.timeline.instructions[0].entries);
}

getPosts().then(posts => {
	fs.writeFileSync(`${userName}.json`, JSON.stringify(posts));
	// console.log(posts)
	// console.log(`Se han obtenido ${posts.length} post`);
